...
@section('title', ' Renewals Report Page')
                ...
                <div class="row g-6 mb-6">
                    ...
                    <div class="col-md-3">
                        <div class="card shadow-sm h-100" style="background-color:#9aa89b; color:white;">
                            <div class="card-body d-flex flex-column justify-content-center align-items-center py-4">
                                <i class="bi bi-arrow-repeat fs-1 mb-2 text-white"></i>
                                <div class="fs-3 fw-bold">{{ $quotations->count() }}</div>
                                <div class="fw-bold fs-7 text-white-75">Renewals This Month</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card shadow-sm h-100" style="background-color:#c0c7c4; color:white;">
                            <div class="card-body d-flex flex-column justify-content-center align-items-center py-4">
                                <i class="bi bi-hourglass-bottom fs-1 mb-2 text-white"></i>
                                <div class="fs-3 fw-bold">{{ $quotations->count() }}</div>
                                <div class="fw-bold fs-7 text-white-75">Expired This Month</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card shadow-sm h-100" style="background-color:#9aa89b; color:white;">
                            <div class="card-body d-flex flex-column justify-content-center align-items-center py-4">
                                <i class="bi bi-exclamation-triangle fs-1 mb-2 text-white"></i>
                                <div class="fs-3 fw-bold">{{ $quotations->where('status', 'success')->count() }}</div>
                                <div class="fw-bold fs-7 text-white-75">Renewals Overdue</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card shadow-sm h-100" style="background-color:#c0c7c4; color:white;">
                            <div class="card-body d-flex flex-column justify-content-center align-items-center py-4">
                                <i class="bi bi-x-circle fs-1 mb-2 text-white"></i>
                                <div class="fs-3 fw-bold">{{ $quotations->where('status', 'cancelled')->count() }}</div>
                                <div class="fw-bold fs-7 text-white-75">Failed Renewals</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-flush h-md-100">
                        ...
                        <div class="card-body pt-6">
                            ...
                            <div class="table-responsive">
                                ...
                                <form method="GET" action="{{ route('kmj.renewals.report') }}" class="row g-3 mb-4"
                                    id="renewalForm">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3 align-self-end">
                                        ...
                                        <a href="{{ route('kmj.renewals.report') }}" class="btn" id="resetBtn"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            resetBtn.addEventListener('click', function(e) {
                ...
                setTimeout(() => {
                    window.location.href = "{{ route('kmj.renewals.report') }}";

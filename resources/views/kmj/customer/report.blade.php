                    ...
                    <div class="col-md-3">
                        <div class="card shadow-sm h-100" style="background-color:#9aa89b; color:white;">
                            <div class="card-body d-flex flex-column justify-content-center align-items-center py-4">
                                ...
                                <div class="fw-bold fs-7 text-white-75">Total Customers</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card shadow-sm h-100" style="background-color:#c0c7c4; color:white;">
                            <div class="card-body d-flex flex-column justify-content-center align-items-center py-4">
                                ...
                                <div class="fs-3 fw-bold" style="color: white">
                                    {{ $customers->count() }}</div>
                                <div class="fw-bold fs-7" style="color: white">Active Customers</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card shadow-sm h-100" style="background-color:#9aa89b; color:white;">
                            <div class="card-body d-flex flex-column justify-content-center align-items-center py-4">
                                ...
                                <div class="fs-3 fw-bold">{{ $customers->where('status', 'inactive')->count() }}</div>
                                <div class="fw-bold fs-7 text-white-75">Inactive Customers</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card shadow-sm h-100" style="background-color:#c0c7c4; color:white;">
                            <div class="card-body d-flex flex-column justify-content-center align-items-center py-4">
                                ...
                                <div class="fs-3 fw-bold" style="color: white">
                                    {{ $customers->count() }}</div>
                                <div class="fw-bold fs-7" style="color: white">Customers</div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <form method="GET" action="#" class="row g-3 mb-4" id="renewalForm">
                                ...
                                <div class="col-md-2 align-self-end">
                                    ...
                                    <a href="{{ route('kmj.customers') }}" class="btn" id="resetBtn"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($customers as $index => $customer)
                                        <tr class="text-gray-700 fw-semibold">
                                            ...
                                            <td>{{ $customer->policyHolderType->name }}</td>
                                            <td>{{ $customer->policy_holder_id_number }}</td>
                                            <td>{{ $customer->policyHolderIdType->name }}</td>
                                            <td>
                                                <a href="{{ route('kmj.customer.show', $customer->id) }}"
                                                    class="btn btn-sm"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            resetBtn.addEventListener('click', function(e) {
                ...
                setTimeout(() => {
                    window.location.href = "{{ route('kmj.customer') }}";

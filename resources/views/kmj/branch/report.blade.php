...
@section('title', ' Branch Report Page')
            ...
            <div id="kt_app_content_container" class="app-container  container-xxl ">
                ...
                <div class="row g-6 mb-6">
                    ...
                    <div class="col-md-3">
                        <div class="card shadow-sm h-100" style="background-color:#c0c7c4; color:white;">
                            <div class="card-body d-flex flex-column justify-content-center align-items-center py-4">
                                ...
                                <div class="fs-3 fw-bold">10</div>
                                <div class="fw-bold fs-7 text-white-75">Total Agents</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card shadow-sm h-100" style="background-color:#9aa89b; color:white;">
                            <div class="card-body d-flex flex-column justify-content-center align-items-center py-4">
                                <i class="bi bi-person-check fs-1 mb-2 text-white"></i>
                    ...
                    <div class="col-md-3">
                        <div class="card shadow-sm h-100" style="background-color:#c0c7c4; color:white;">
                            <div class="card-body d-flex flex-column justify-content-center align-items-center py-4">
                                <i class="bi bi-person-dash-fill fs-1 mb-2 text-white"></i>
                                <div class="fs-3 fw-bold">0</div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            resetBtn.addEventListener('click', function(e) {
                ...
                setTimeout(() => {
                    window.location.href = "{{ route('kmj.getBranches.report') }}";

                            ...
                            @php
                                $transactions = [
                                    (object) [
                                        ...
                                        'payment' => 'Cash',
                                        'premium' => 1250.5,
                                        'created_at' => '2025-11-27 10:15:00',
                                        'status' => 'Active',
                                    ],
                                    (object) [
                                        'client' => 'Sarah Daniel',
                                    ...
                                    (object) [
                                        ...
                                        'payment' => 'Mobile',
                                        'premium' => 2200.0,
                                        'created_at' => '2025-11-25 09:45:00',
                                        'status' => 'Expired',
                                    ],
                                ];
                            @endphp
                                ...
                                <tbody>
                                    @foreach ($transactions as $index => $txn)
                                        <tr class="text-gray-700 fw-semibold">
                                            ...
                                            <td>{{ $txn->region }}</td>
                                            <td>{{ $txn->payment }}</td>
                                            <td>{{ number_format($txn->premium, 2) }}</td>
                                            <td>{{ \Carbon\Carbon::parse($txn->created_at)->format('d M Y, h:i A') }}</td>
                                            <td>{{ $txn->status }}</td>
                                            <td>
                                                <a href="{{ route('transaction.show',$txn->client) }}" class="btn btn-sm"

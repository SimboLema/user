...
<div class="modal fade" id="largeModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="modalTitle">New producer user</h5>
        ...
        <form class="row g-3 needs-validation" novalidate id="form" onsubmit="save(event)" enctype="multipart/form-data">
            ...
            <div class="modal-body overflow-auto" style="max-height: 400px;">
                <div class="row g-6">
                    ...
                    <div class="col-md-6 form-group">
                        <label for="producer_id" class="form-label">Production Company<span class="text-danger">*</span></label>
                        <select class="form-control select2" id="producer_id" name="producer_id" required>
                            <option value="">Select  Center</option>
                            @foreach($producers as $center)
...
<script>
    ...
    function clear_input() {
        ...
        $("#hidden_id").val("")
        $("#submitBtn").html("Save")
        $("#modalTitle").html("New producer user");
    }
    ...
    function editProducerUser(id) {
        $.ajax({
            url: "/producer_user/edit/" + id,
            type: "GET",
            dataType : 'json',
            success: function (data) {
                let row = data.data;
                ...
                $("#producer_id").val(row.producer_id);
                ...
                $("#modalTitle").html("Update Producer User");
    ...
    function deleteProducerUser(id) {
        if (!confirm("Are you sure?")) return;
        $.ajax({
            url: "/producer_user/delete/" + id,
            type: "GET",
            dataType : 'json',
            success: function (data) {
                if (data.status == 200) {

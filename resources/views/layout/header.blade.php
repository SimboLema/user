...
<div class="d-flex justify-content-sm-between align-items-sm-center ">
    <h6 class="card-title mb-sm-0 ">@yield('page-title')</h6>
</div>
      <ul class="navbar-nav flex-row align-items-center ms-md-auto">
        ...
        {{-- <li class="nav-item dropdown-language dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end">
            ...
            <li>
              <a class="dropdown-item" href="javascript:void(0);" data-language="swa" data-text-direction="ltr">
                <span>Swahili</span>
              </a>
            </li>
        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end">
            <li>
              <a class="dropdown-item mt-0" href="/user/show/{{\Crypt::encrypt(Auth::user()->id)}}">
                <div class="d-flex align-items-center">
                  <div class="flex-shrink-0 me-2">
                    <div class="avatar avatar-online">
                      <img src="{{ auth()->user() &&  auth()->user()->avatar ? asset('storage/'.auth()->user()->avatar) : '../../assets/img/avatars/1.png' }}" alt class="rounded-circle" />
                    </div>
                  </div>
                  <div class="flex-grow-1">
                    <h6 class="mb-0">{{auth()->user()->name ?? ""}}</h6>
                    <small class="text-body-secondary">{{auth()->user()->roleRow->name ?? ""}}</small>
                  </div>
                </div>
              </a>
            </li>
            ...
            <li>
              <a class="dropdown-item" href="/user/show/{{\Crypt::encrypt(Auth::user()->id)}}"> <i class="icon-base ti tabler-user me-3 icon-md"></i><span class="align-middle">My Profile</span> </a>
            </li>

            @if( Gate::check('show setting'))
            <li>
              <a class="dropdown-item" href="/setting"> <i class="icon-base ti tabler-settings me-3 icon-md"></i><span class="align-middle">Settings</span> </a>
            </li>
            @endif

        ...
        <form class="row g-3 needs-validation" novalidate id="form" onsubmit="save(event)" enctype="multipart/form-data">
            ...
            <div class="modal-body overflow-auto" style="max-height: 400px;">
                <div class="row g-6">
                    ...
                    <div class="col-md-6 form-group">
                        <label for="gps_tracker_id" class="form-label">Gps Tracker</label>
                        <select class="form-control select2" id="gps_tracker_id" name="gps_tracker_id" >
...
<script>
    ...
    function clear_input() {
        ...
        $("#hidden_id").val("")
        $("#submitBtn").html("Save")
        $("#modalTitle").html("New Waste Picker");
    }
    ...
    function editWastePicker(id) {
        $.ajax({
            url: "/waste_picker/edit/" + id,
            type: "GET",
            dataType : 'json',
            success: function (data) {
                let row = data.data;
                ...
                $("#gps_tracker_id").val(row.gps_tracker_id);
                ...
                $("#modalTitle").html("Update Waste Picker");
    ...
    function deleteWastePicker(id) {
        if (!confirm("Are you sure?")) return;
        $.ajax({
            url: "/waste_picker/delete/" + id,
            type: "GET",
            dataType : 'json',
            success: function (data) {
                if (data.status == 200) {

                    ...
                    <div class="row g-6">
                        ...
                        @if ($role == 4)
                            <div class="col-md-6 form-group">
                                ...
                                <select name="facility_id" id="facility_id" class="form-cotrol select2" required>
                        ...
                        @if ($role == 5)
                            <div class="col-md-6 form-group">
                                ...
                                <select name="producer_id" id="producer_id" class="form-control select2" required>
...
<script>
    ...
    function editProduct(id) { // Updated function name
        document.getElementById('form').reset();
        $("#hidden_id").val("");

        jQuery.ajax({
            type: "GET",
            url: "/product/edit/" + id, // Updated URL
            dataType: 'json',
            success: function (data) {
    ...
    function deleteProduct(id) { // Updated function name
        ...
        jQuery.ajax({
            type: "GET",
            url: "/product/delete/" + id, // Updated URL
            dataType: 'json',
            success: function (data) {
                if (data.status == 200) {
                    showFlashMessage("success", data.message);

            ...
            <div class="modal-body overflow-auto" style="max-height: 400px;">
                <div class="row g-6">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name" placeholder="Enter Recycling Facility Name" required>
                    </div>
...
<script>
    ...
    function clear_input() {
        ...
        $("#hidden_id").val("")
        $("#submitBtn").html("Save")
        $("#modalTitle").html("New Recycling Facility");
    }
    ...
    function editRecyclingFacility(id) {
        document.getElementById('form').reset();
        $("#hidden_id").val("")

        jQuery.ajax({
            type: "GET",
            url: "/recycling_facility/edit/" + id,
            dataType: 'json',
            success: function (data) {
                let row = data.data;
                ...
                $("#modalTitle").html("Update Recycling Facility");
    ...
    function deleteRecyclingFacility(id) {
        if (!confirm("Are you sure you want to delete this recycling facility?")) return;

        jQuery.ajax({
            type: "GET",
            url: "/recycling_facility/delete/" + id,
            dataType: 'json',
            success: function (data) {
                if (data.status == 200) {
                    showFlashMessage("success", data.message);

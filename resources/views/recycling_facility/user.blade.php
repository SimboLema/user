...
<div class="d-flex justify-content-sm-between align-items-sm-center pb-2">
    ...
    <div class="action-btns">
        @can('create recycling facility user')
        ...
        <form class="row g-3 needs-validation" novalidate id="form" onsubmit="save(event)" enctype="multipart/form-data">
            ...
            <div class="modal-body overflow-auto" style="max-height: 400px;">
                <div class="row g-6">
                    ...
                    <div class="col-md-6 form-group">
                        <label for="facility_id" class="form-label">Recycling Facility<span class="text-danger">*</span></label>
                        <select class="form-control select2" id="facility_id" name="facility_id" required>
                            <option value="">Select Recycling Facility</option>
                            @foreach($recycling_facilities as $facility)
...
<script>
    ...
    function getView() {
        ...
        $.ajax({
            url: "/recycling_facility_user/view",
            type: "GET",
    ...
    function clear_input() {
        ...
        $("#hidden_id").val("")
        $("#submitBtn").html("Save")
        $("#modalTitle").html("New Recycling Agent");
    }
    ...
    function save(e) {
        ...
        $.ajax({
            url: "/recycling_facility_user/save",
            type: "POST",
            data: formData,
            processData: false,
            contentType: false,
    ...
    function editRecyclingFacilityUser(id) {
        $.ajax({
            url: "/recycling_facility_user/edit/" + id,
            type: "GET",
            dataType : 'json',
            success: function (data) {
                let row = data.data;
                ...
                $("#modalTitle").html("Update Recycling Agent");
    ...
    function deleteRecyclingFacilityUser(id) {
        if (!confirm("Are you sure?")) return;
        $.ajax({
            url: "/recycling_facility_user/delete/" + id,
            type: "GET",
            dataType : 'json',
            success: function (data) {
                if (data.status == 200) {

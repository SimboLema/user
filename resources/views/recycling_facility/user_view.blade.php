                    ...
                    <tr class="row-clickable" data-id="{{ \Crypt::encrypt($user->id) }}">
                        ...
                        <td class="Action">
                            @can('edit collection center user')
                                <button type="button" onclick="editRecyclingFacilityUser('{{ $user->id }}')" class="btn btn-success btn-sm">
                                    <i class="bi bi-pencil"></i>
                                </button>
                            @endcan
                            @can('delete collection center user')
                                <button type="button" onclick="deleteRecyclingFacilityUser('{{ $user->id }}')" class="btn btn-danger btn-sm">

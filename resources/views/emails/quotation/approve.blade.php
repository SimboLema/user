{{-- resources/views/emails/quotation/approved.blade.php --}}
<!DOCTYPE html>
<html>
<head>
    <style>
        ...
        .badge-approved { background: #d1e7dd; color: #0a3622; padding: 4px 12px; border-radius: 20px; font-size: 13px; }
...
<body>
    <div class="card">
        <h2 style="color: #003153;">Quotation Approved ✅</h2>
        <p>Great news! The insurer has <strong>approved</strong> the quotation. You may now proceed to send it to TIRA.</p>

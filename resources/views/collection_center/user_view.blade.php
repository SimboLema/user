                    ...
                    <tr class="row-clickable" data-id="{{ \Crypt::encrypt($user->id) }}">
                        ...
                        <td class="Action">
                            @can('edit collection center user')
                                <button type="button" onclick="editCollectionCenterUser('{{ $user->id }}')" class="btn btn-success btn-sm">
                                    <i class="bi bi-pencil"></i>
                                </button>
                            @endcan
                            @can('delete collection center user')
                                <button type="button" onclick="deleteCollectionCenterUser('{{ $user->id }}')" class="btn btn-danger btn-sm">

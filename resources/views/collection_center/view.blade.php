            ...
            <tbody class="list">
                @foreach ($data as $index => $center)
                    <tr class="row-clickable" data-id="{{ \Crypt::encrypt($center->id) }}">
                        ...
                        <td class="Action">
                            @can('edit collection center')
                                <button type="button" onclick="editCollectionCenter('{{ $center->id }}')" class="btn btn-success btn-sm">
                                    <i class="bi bi-pencil"></i>
                                </button>
                            @endcan
                            @can('delete collection center')
                                <button type="button" onclick="deleteColectionCenter('{{ $center->id }}')" class="btn btn-danger btn-sm">
